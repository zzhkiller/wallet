...
public class BalanceUtils {
   ...
   * @return
   */
  public static int getGasPriceMinGwei() {
    BigInteger gasPriceMin = BigInteger.valueOf(GAS_PRICE_MIN);
    return BalanceUtils.weiToGweiBI(gasPriceMin).intValue();
  }
