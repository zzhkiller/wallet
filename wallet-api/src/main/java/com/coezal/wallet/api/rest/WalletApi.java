...
public interface WalletApi {
  ...
  BaseResponse<GetAddressResponse> getAddr(@ApiParam(value = "请求", required = true)  String datastr);

  @ApiOperation(value = "校验充值请求是否真实", notes = "校验充值请求是否真实", protocols = "https")
  @RequestMapping(value = "/paycheck", method = RequestMethod.POST)
  BaseResponse<PayCheckResponse> payCheck(@ApiParam(value = "请求", required = true)  String datastr);
  ...
  BaseResponse<String> paySearch(@ApiParam(value = "请求", required = true) String datastr);
